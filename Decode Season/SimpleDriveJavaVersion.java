...
@TeleOp(name="SimpleDriveJavaVersion")

public class SimpleDriveJavaVersion extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    // drive program
    driveToDistance(24,0.4);
    turnToYaw(180,0.2);
    driveToDistance(12,0.3);
    turnToYaw(0,0.2);
    driveToDistance(-12,0.2);

    
    // sleep to allow reading of driver hub
    sleep(20000);
  }
